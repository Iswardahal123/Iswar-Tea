...
const txt = {
  ...
  hi: {
    ...
    waterLabel: "💧 पत्तियों में पानी है?",
    waterNone: "— चुनें —",
    waterYes: "💧 हाँ, पानी है",
    waterNo: "🌱 नहीं, सूखा है",
  },
  ne: {
    ...
    waterLabel: "💧 पातमा पानी छ?",
    waterNone: "— छान्नुस् —",
    waterYes: "💧 हो, पानी छ",
    waterNo: "🌱 होइन, सुक्खा छ",
  },
  as: {
    ...
    waterLabel: "💧 পাতত পানী আছে নে?",
    waterNone: "— বাছক —",
    waterYes: "💧 হয়, পানী আছে",
    waterNo: "🌱 নাই, শুকান পাত",
  },
};
...
export default function EntryFormPage({ user }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await addDoc(collection(db, "entries"), {
        ...
        waterStatus: form.waterStatus || "none", // "yes" | "no" | "none"
  ...
  // Water select border color changes based on selection
