              ...
              {eTotalAmount > 0 && (
                <div style={{
                  ...
                  <div style={styles.calcHint}>
                    Rs{eTotalAmount.toFixed(0)} - Rs{eAdvance} - Rs{eReceived} = Rs{eBalance.toFixed(2)}
                  </div>
                </div>
              )}
              <div style={styles.field}>
...
const styles = {
  ...
  closeBtn: {
    ...
    borderRadius: "50%", cursor: "pointer", fontSize: "14px", fontWeight: "700", fontFamily: "inherit",
  },
